...
#    import json
#    param_dict = {
#        "name"   : name+'_'+str(width)+'x'+str(height),
#        "width"  : width,
#        "height" : height,
#        "mtx"    : intrinsic.tolist(),  # convert np arrays to lists
#        "dist"   : distortion.tolist()  # so json can handle them
#    }
#    J = open(name+'_'+str(width)+'x'+str(height)+'_parameters.json','w')
#    J.write(json.dumps(param_dict, indent=4))
#    J.close()
